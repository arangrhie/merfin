...
If you have multiple data types (e.g. HiFi and Illumina) you can also assess the K* agreement between them genome-wide generating a cartesian plot. Use the same output of `-dump` with the scripts under `scripts/cartesian_plot`.
